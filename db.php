...
class Db
{
	...
	public static function setup($options)
	{
		...
		if (function() { if(isset($options["escapeSqlIdentifiers"])) {$escapeIdentifiers = $options["escapeSqlIdentifiers"]; return $escapeIdentifiers; } else { return false; } }())
		{
			globals_set("db.escape_identifiers", $escapeIdentifiers);

		}

		if (function() { if(isset($options["forceCasting"])) {$forceCasting = $options["forceCasting"]; return $forceCasting; } else { return false; } }())
		{
